...
var Executor = /** @class */ (function () {
    ...
    Executor.prototype.sendInlineComments = function (results, git, previousComments) {
        ...
        return Promise.all(__spreadArrays([
            this.sendInlineReview(git, inlineResultsForReview).catch(function (_e) {
                return inlineResultsForReview.forEach(function (inlineResult) { return DangerResults_1.inlineResultsIntoResults(inlineResult); });
            })
        ], commentPromises)).then(function (dangerResults) {
            return new Promise(function (resolve) {
                resolve(dangerResults.slice(1).reduce(function (acc, r) { return DangerResults_1.mergeResults(acc, r); }, emptyResult));
            });
        });
    };
